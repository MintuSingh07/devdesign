...
export function BackgroundDecor() {
  ...
  return (
    <div className="fixed inset-0 -z-50 h-full w-full overflow-hidden bg-[#030303]">
      ...
      {/* Spotlight from top */}
      <div className="absolute left-1/2 top-0 -translate-x-1/2 h-[1200px] w-[1600px] bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.35)_0%,transparent_70%)] opacity-100 pointer-events-none" />
      ...
      <motion.div
        ...
        className="pointer-events-none absolute h-[800px] w-[800px] rounded-full bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.25)_0%,transparent_60%)] blur-[80px]"
      />
