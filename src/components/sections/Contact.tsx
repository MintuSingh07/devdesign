    ...
    return (
      <section id="contact" className="w-full px-6 py-24 lg:px-24 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:gap-24 relative z-10">
            {/* Left Side: Info */}
            <div className="flex flex-1 flex-col gap-6 sm:gap-8 text-center lg:text-left">
              <div className="flex flex-col gap-4">
                  <h2 className="text-3xl font-black tracking-tight text-white sm:text-6xl bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent leading-[1.1] font-display">Let&apos;s build something <span className="text-blue-500 italic">amazing</span> together.</h2>
                  <p className="max-w-xl text-base sm:text-lg text-zinc-400 font-medium font-sans">
                  Whether you have a project in mind or just want to say hi, my inbox is always open. 
                </p>
              </div>

              <div className="flex flex-col gap-4 sm:gap-6 text-zinc-400 font-sans">
            ...
            <div className="flex-1 w-full">
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative flex flex-col gap-6 sm:gap-8 rounded-[2rem] sm:rounded-[2.5rem] border border-white/5 bg-zinc-900/40 p-6 sm:p-10 backdrop-blur-md shadow-2xl"
              >
                {/* Form Ambient Light */}
